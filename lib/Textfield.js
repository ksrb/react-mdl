...
var Textfield = (function (_MDL$UpgradedComponent) {
  ...
  Textfield.prototype.componentDidUpdate = function componentDidUpdate(prevProps) {
    if (this.props.required !== prevProps.required || this.props.pattern !== prevProps.pattern || this.props.value !== prevProps.value) {
      _reactDom2['default'].findDOMNode(this).MaterialTextfield.checkValidity();
    }
    if (this.props.disabled !== prevProps.disabled) {
      _reactDom2['default'].findDOMNode(this).MaterialTextfield.checkDisabled();
    }
    ...
    if (this.props.value !== prevProps.value) {
      _reactDom2['default'].findDOMNode(this).MaterialTextfield.checkDirty();
    }
  };
  ...
  Textfield.prototype.render = function render() {
    ...
    var field = expandable ? _react2['default'].createElement(
      'div',
