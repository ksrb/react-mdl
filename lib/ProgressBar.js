...
var ProgressBar = (function (_MDL$UpgradedComponent) {
  _inherits(ProgressBar, _MDL$UpgradedComponent);
  ...
  ProgressBar.prototype.componentDidMount = function componentDidMount() {
    _MDL$UpgradedComponent.prototype.componentDidMount.call(this);
  ...
  ProgressBar.prototype.setProgress = function setProgress(progress) {
    if (!this.props.indeterminate && typeof progress !== 'undefined') {
      _reactDom2['default'].findDOMNode(this).MaterialProgress.setProgress(progress);
    }
  };

  ProgressBar.prototype.setBuffer = function setBuffer(buffer) {
    if (typeof buffer !== 'undefined') {
      _reactDom2['default'].findDOMNode(this).MaterialProgress.setBuffer(buffer);
    }
  };
